...
namespace QuanLiNhanSu
{
    public partial class Home : Form
    {
        ...
        private void Home_Load(object sender, EventArgs e)
        {
            ...
            if (quyen > 0) { 
                btn_Luong_.Enabled = false;
                btn_Taikhoan_.Enabled = false;
            }
        }
        ...
        private void btn_Luong__Click(object sender, EventArgs e)
        {
        ...
        private void btn_Chamcong__Click(object sender, EventArgs e)
        {
        ...
        private void btn_Thongke__Click(object sender, EventArgs e)
        {
